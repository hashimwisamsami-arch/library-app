...
const Sidebar = ({
  ...
  return (
    <>
      ...
      <div
        className={`${s.mobileOverlay} ${open ? s.mobileOverlayOpen : s.mobileOverlayClosed}`}
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <ChevronRight
                  size={16}
                  className={active ? s.navChevronActive : s.navChevronActive}
                />
              </Link>
            );
          })}
          ...
          {footerItems.map((item) => {
            ...
            return (
              <Link
                key={item.label}
                to={item.href}
                className={`${s.footerLink} ${item.kind === "primary" ? s.footerLinkPrimary : s.footerLinkSecondary}`}
              >
                <span className={s.footerIconWrapper}>
                  <Icon size={16} />
                  {item.label}
